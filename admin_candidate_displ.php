...
if (isset($_GET['delete'])) {
    $slid = $_GET['delete'];
    $delete_sql = "DELETE FROM candidate_db WHERE slid = $slid";
    if ($con->query($delete_sql) === TRUE) {
        header("Location: admin_candidate_displ.php");
        exit();
    } else {
    ...
    <div class="cont">
        ...
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="admin_candidate_displ.php" style="padding-right: 64px;" class="active">
        ...
        <main>
            <div class="scroll">
                <header><b>Candidate Details</b></header>
                <form method="POST" action="admin_candidate_displ.php">
                    <div class="column">
                        <div class="drop">
                            <label>State:</label>
                ...
                <section class="container">
                    ...
                    if (!empty($candidates_data)) {
                        echo "<table>";
                        echo "<thead><tr><th>Party Name</th><th>Party Symbol</th><th>Candidate Name</th><th>Actions</th></tr></thead>";
                        echo "<tbody>";
                        foreach ($candidates_data as $candidate) {
                            ...
                            echo "<td class='action-buttons'>
                                    <a href='admin_candidate_edit.php?slid=" . $candidate['slid'] . "' class='btn edit'>Edit</a>
                                    <a href='admin_candidate_displ.php?delete=" . $candidate['slid'] . "' class='btn delete'>Delete</a>
                                  </td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
